...
resourcename="crmsystem"  # lower case, only
resourcegroup="crmsystem_rg"
...
# git clone https://github.com/apilogicserver/crmsystem.git
# cd crmsystem
...
az group create --name crmsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group crmsystem_rg --sku S1 --is-linux
az container create --resource-group crmsystem_rg --name crmsystem --image apilogicserver/crmsystem:latest --dns-name-label crmsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//crmsystem.westus.azurecontainer.io:5656'
